...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-spp.cfg', help='*.cfg path')    #changed
    parser.add_argument('--data', type=str, default='data/rbc.data', help='*.data path')  #changed
